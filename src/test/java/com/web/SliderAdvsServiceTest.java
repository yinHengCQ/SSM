...
public class SliderAdvsServiceTest {
	...
	public void testInsert() {
		...
		for (int i = 7; i <= 16; i++) {
			SlideAdvs s=new SlideAdvs();
			s.setAdvsImage("advsImage");
			s.setAdvsName("advsName");
			s.setAdvsUrl("advsUrl");
			s.setUserWeiXinId(i);
			slideAdvsService.insert(s);
		}
	}
	...
	public void testSearch() {
		...
		criteria1.andEqualTo("advsUrl", "advsUrl");
		// 执行查询
		List<SlideAdvs> arr = this.slideAdvsService.search(builder);
