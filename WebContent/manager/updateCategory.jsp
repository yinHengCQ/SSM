...
<body>
	...
	<div class="main">
		...
		<div class="main-roght col-md-10">
			<form method="post" class="form-horizontal myForm" action="${pageContext.request.contextPath }/manager/updateCategory.action">
				
				<input type="hidden" name="cateId" value="${category.cateId }">
				<input type="hidden" name="userWeiXinId" value="${category.userWeiXinId }">
				<div class="form-group">
					<label class="col-md-2 control-label">分类名称</label>
					<div class="col-md-4">
						<input class="form-control" type="text" name="cateName" value="${category.cateName }">
					</div>
				</div>					
				<div class="form-group">					
					<label class="col-md-2 control-label">分类图片</label>
					<div class="col-md-4">
						<input class="form-control" type="text" id="url" name="cateImage" value="${category.cateImage }"/>
					</div>
					<div class="col-md-4">
				...
				<div class="form-group">		
					<div class="col-md-offset-2 col-md-4" >
						<img id="new_image" src="${category.cateImage }"  width="120" height="120">									
					</div>			
				</div>				
				<div class="form-group">
					<label class="col-md-2 control-label">分类外部连接地址</label>
					<div class="col-md-4">
						<input class="form-control" type="text" name="cateUrl" value="${category.cateUrl }">
					</div>
				</div>					
				<div class="form-group">
					<label class="col-md-2 control-label">分类排序</label>
					<div class="col-md-4">
						<input class="form-control" type="text" name="cateSort" value="${category.cateSort }">
					</div>
				</div>					
