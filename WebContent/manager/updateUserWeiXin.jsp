...
<body>
	...
	<div class="main">
		...
		<div class="main-roght col-md-10">
			...
			<form method="post" class="form-horizontal myForm" action="${pageContext.request.contextPath }/manager/updateUserWeiXin.action">
				<input type="hidden" name="userWeiXinId" value="${userWeiXin.userWeiXinId }">
				<input type="hidden" name="userId" value="${sessionScope.userInfo.userId }">
				
				<div class="form-group">
					<label class="col-md-2 control-label">微信原始ID</label>
					<div class="col-md-4">
						<input class="form-control" type="text" name="wxId" value="${userWeiXin.wxId }">
					</div>
				</div>																		
				<div class="form-group">					
					<label class="col-md-2 control-label">微信头像</label>
					<div class="col-md-4">
						<input class="form-control" type="text" id="url_wxHead" value="${userWeiXin.wxHead }" name="wxHead"/>
					</div>
					<div class="col-md-4">
				...
				<div class="form-group">		
					<div class="col-md-offset-2 col-md-4" >
						<c:if test="${not empty userWeiXin.wxHead }">
							<img id="new_wxHead" src="${userWeiXin.wxHead }"  width="120" height="120">
						</c:if>										
					</div>			
				</div>	
				<div class="form-group">					
					...
					<div class="col-md-4">
						<input class="form-control" type="text" id="url_qrCode" value="${userWeiXin.qrCode }" name="qrCode"/>
					</div>
					<div class="col-md-4">
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-4" >					
						<c:if test="${not empty userWeiXin.qrCode }">
							<img id="new_qrCode" src="${userWeiXin.qrCode }"  width="120" height="120">
						</c:if>	
					</div>								
				</div>					
				<div class="form-group">
					...
					<div class="col-md-4">
						<input class="form-control" type="text" name="wxName" value="${userWeiXin.wxName }">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-2 control-label">微信号</label>
					<div class="col-md-4">
						<input class="form-control" type="text" name="wxCode" value="${userWeiXin.wxCode }">
					</div>
				</div>	
				<div class="form-group">
					<label class="col-md-2 control-label">微信类型</label>
					<div class="col-md-4">
						<input class="form-control" type="text" name="wxType" value="${userWeiXin.wxType }">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-2 control-label">token</label>
					<div class="col-md-4">
						<input class="form-control" type="text" name="token" value="${userWeiXin.token }">
					</div>
				</div>	
