...
<body>
	...
	<div class="main">
		...
		<div class="main-roght col-md-10">
			<form method="post" class="form-horizontal myForm" action="${pageContext.request.contextPath }/manager/updateArticle.action">
				
				<input type="hidden" name="articleId" value="${article.articleId }">
				<input type="hidden" name="userWeiXinId" value="${article.userWeiXinId }">
					...
					<div class="col-md-4">
						<select class="form-control" name="cateId">
							<c:forEach items="${list }" var="r">							
								<option value="${r.cateId }" <c:if test="${article.cateId==r.cateId }">selected="selected"</c:if>>
									${r.cateName }
								</option>
							</c:forEach>
						</select>
				...
				<div class="form-group">					
					...
					<div class="col-md-4">
						<input class="form-control" type="text" id="url" name="articleImage" value="${article.articleImage }"/>
					</div>
					<div class="col-md-4">
				...
				<div class="form-group">		
					<div class="col-md-offset-2 col-md-4" >
						<img id="new_image" src="${article.articleImage }"  width="120" height="120">									
					</div>			
				</div>				
				<div class="form-group">
					<label class="col-md-2 control-label">外部连接地址</label>
					<div class="col-md-4">
						<input class="form-control" type="text" name="articleUrl" value="${article.articleUrl }">
					</div>
				</div>					
				<div class="form-group">
					<label class="col-md-2 control-label">图文详细内容</label>
					<div class="col-md-4">
						<textarea id="content1" class="form-control" name="articleContext" style="height: 350px">${article.articleContext }</textarea>
					</div>
				</div>					
