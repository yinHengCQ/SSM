...
<body>
	...
	<div class="main">
		...
		<div class="main-roght col-md-10">
			<form method="post" class="form-horizontal myForm" action="${pageContext.request.contextPath }/manager/addSlideAdvs.action">
				
				<input type="hidden" name="userWeiXinId" value="${userWeiXinId }">
				<div class="form-group">
					<label class="col-md-2 control-label">幻灯片描述</label>
					<div class="col-md-4">
						<input class="form-control" type="text" name="advsName">
					</div>
				</div>					
				<div class="form-group">					
					<label class="col-md-2 control-label">图片地址</label>
					<div class="col-md-4">
						<input class="form-control" type="text" id="url" name="advsImage"/>
					</div>
					<div class="col-md-4">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input class="form-control" type="text" name="advsUrl">
					</div>
				</div>								
