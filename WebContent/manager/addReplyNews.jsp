...
<body>
	...
	<div class="main">
		...
		<div class="main-roght col-md-10">
			<form method="post" class="form-horizontal myForm" action="${pageContext.request.contextPath }/manager/addReplyNews.action">
				
				<input type="hidden" name="replyId" value=<%=request.getParameter("replyId") %>>
				<div class="form-group">
					<label class="col-md-2 control-label">消息标题</label>
					<div class="col-md-4">
						<input class="form-control" type="text" name="replyNewsTitle">
					</div>
				</div>					
				<div class="form-group">					
					<label class="col-md-2 control-label">消息图片</label>
					<div class="col-md-4">
						<input class="form-control" type="text" id="url" name="replyImageUrl"/>
					</div>
					<div class="col-md-4">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input class="form-control" type="text" name="replyUrl">
					</div>
				</div>					
				<div class="form-group">
					<label class="col-md-2 control-label">消息备注</label>
					<div class="col-md-4">
						<textarea class="form-control" name="replyDecription" rows="5"></textarea>
					</div>
				</div>					
